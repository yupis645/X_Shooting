...
ENEMY_ST  A_enemyDate[] = {
	//			番号			画像のサイズ					当たり判定サイズ, アニメの数,得点,速度,加速度
	//		番号↓					↓									  ↓,  　　　　 ↓　　↓  ↓     ↓
	/*トーロイド*/		{0  , {0 ,0 ,0 ,0 },32 ,true ,false ,0 ,0 ,0 ,0 ,0 ,32, 0, 0 ,0 ,1  ,0 , 8 ,0 ,30  ,2 ,0 , 0, 0,0.04,{nullptr,}  },
	...
	/*ジゾー*/			{3  , {0 ,0 ,0 ,0 },32 ,true ,false ,0 ,0 ,0 ,0 ,0 ,32, 0 ,0, 0 ,1  ,24 ,4 ,0 ,70  ,3 ,0 , 0, 0,0.0  ,{nullptr,}  },
	/*ジアラ*/			{4  , {0 ,0 ,0 ,0 },32 ,true ,false ,0 ,0 ,0 ,0 ,0 ,32, 0 ,0, 0 ,1  ,32 ,6 ,0 ,150 ,4 ,0 , 0, 0,0.08 ,{nullptr,}  },
	...
	/*ザカート*/		{7  , {0 ,0 ,0 ,0 },16 ,true ,false ,0 ,0 ,0 ,0 ,0 ,32, 0 ,0, 0 ,1  ,56 ,1 ,0 ,100 ,3 ,0 , 0, 0,0.0  ,{nullptr,}  },
	/*ブラグザカート*/	{8  , {0 ,0 ,0 ,0 },16 ,true ,false ,0 ,0 ,0 ,0 ,0 ,32, 0 ,0, 0 ,1  ,64 ,1 ,0 ,600 ,3 ,0 , 0, 0,0.0  ,{nullptr,}  },
...
//float acc;		//加速度
//Bmp* pic[A_ENEMY_PIC_LINE * 10];		//画像ポインタ
...
//通常の建造物
	 ...
	 /*ログラム*/		{52 , {0 ,0 ,0 ,0 },32 ,true ,false ,0  ,0  ,0 ,0 ,0 ,32, 0, 0 ,0 ,1  ,8 , 4 ,0 ,300  ,0   , 0, 0 ,0 ,0  ,{nullptr,}  },
	 ...
	 /*グロブダー*/		{55 , {0 ,0 ,0 ,0 },32 ,true ,false ,0  ,0  ,0 ,0 ,0 ,32, 0, 0 ,0 ,1  ,20, 4 ,0 ,200 ,0.5 , 0, 0 ,0 ,0.5,{nullptr,}  },
